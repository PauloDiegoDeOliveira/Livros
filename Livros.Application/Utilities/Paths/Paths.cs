namespace Livros.Application.Utilities.Paths
{
    public class Paths
    {
        public static readonly Dictionary<string, Url> Urls = new()
        {
            ...
            { "ObraHomologacao", new Url { IP = "\\\\192.168.103.20\\Sites\\Sistemas\\Livros\\Arquivos\\Obra\\Imagens", DNS = "https://Livros/Obra/Imagens", SPLIT = "Livros/"} },
            { "ObraProducao", new Url { IP = "\\\\192.168.103.20\\Sites\\Sistemas\\Livros\\Arquivos\\Obra\\Imagens", DNS = "https://Livros/Obra/Imagens", SPLIT = "Livros/"} },
        };
    }
}