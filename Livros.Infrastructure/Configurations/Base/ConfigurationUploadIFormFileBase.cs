...
namespace Livros.Infrastructure.Configurations.Base
{
    public class ConfigurationUploadIFormFileBase<TEntity> : IEntityTypeConfiguration<TEntity> where TEntity : UploadIFormFileBase
    {
